...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/UltraGate-Project/UltraGate/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign UltraGate Core for Linux, Windows, and OS X:

    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit ultragate=v${VERSION} ../ultragate/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit ultragate=v${VERSION} ../ultragate/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit ultragate=v${VERSION} ../ultragate/contrib/gitian-descriptors/gitian-osx.yml
    ...
    ./bin/gbuild --memory 3000 --commit ultragate=v${VERSION} ../ultragate/contrib/gitian-descriptors/gitian-aarch64.yml
    ./bin/gsign --signer $SIGNER --release ${VERSION}-aarch64 --destination ../gitian.sigs/ ../ultragate/contrib/gitian-descriptors/gitian-aarch64.yml
    mv build/out/ultragate-*.tar.gz build/out/src/ultragate-*.tar.gz ../
    popd
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`ultragate-${VERSION}-osx-unsigned.dmg`, `ultragate-${VERSION}-osx64.tar.gz`)
...
Codesigner only: Sign the osx binary:
    ...
    transfer ultragate-osx-unsigned.tar.gz to osx for signing
...
- Detached signatures will then be committed to the [ultragate-detached-sigs](https://github.com/UltraGate-Project/ultragate-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the ultragate.org server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/UltraGate-Project/UltraGate/releases/new) with a link to the archived release notes.
