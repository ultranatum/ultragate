Ultragate Core version *3.4.0* is now available from:  <https://github.com/ultranatum/ultragate/releases>

This is a new major version release, including various bug fixes and performance improvements.

Please report bugs using the issue tracker at github: <https://github.com/ultranatum/ultragate/issues>
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/ultranatum-translations/), the QA team during Testing and the Node hosts supporting our Testnet.
