...
In order to support loading of multiple wallets in ultragate-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ultragate.cpp.
...
Changes to ultragate.cpp
----------------------
ultragate.cpp is the entry point into ultragate-qt, and as such, will require some minor modifications to provide hooks for
