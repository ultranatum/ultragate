...
This document provides guidelines for internationalization of the Ultragate Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Ultragate network</numerusform>
            <numerusform>%n active connections to Ultragate network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ultragate_en.ts` remains unchanged.
