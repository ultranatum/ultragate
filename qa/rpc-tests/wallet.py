...
#   c) node1 mines 32 blocks, so now node 0 has 60001ulg, node 1 has 4250ulg, node2 has none.
#   d) node0 sends 601 ulg to node2, in two transactions (301 ulg, then 300 ulg).
