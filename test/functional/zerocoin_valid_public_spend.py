...
from fake_stake.base_test import Ultragate_FakeStakeTest

class zULGValidCoinSpendTest(Ultragate_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zULGs..." % DENOM_TO_USE)
