...
public:
    ...
    // int UltragateBadBlockTime() const { return nUltragateBadBlockTime; }
    // int UltragateBadBlocknBits() const { return nUltragateBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    // int64_t nUltragateBadBlockTime;
    // unsigned int nUltragateBadBlocknBits;
