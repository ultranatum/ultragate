...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            if (ptrCategory->count(std::string("ultragate"))) {
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "ultragate.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "ultragated.pid"));
