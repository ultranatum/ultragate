...
extern bool fGlobalUnlockSpendCache; // Bool used for letting the precomputing thread know that zulgspends need to use the cs_spendcache
...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 ULG at the same time
...
enum ZerocoinSpendStatus {
    ...
    ZULG_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
...
public:
    ...
    std::string GetUniqueWalletBackupName(bool fzulgAuto) const;
    ...
    */
    ...
    bool fBackupMints;
    std::unique_ptr<CzULGTracker> zulgTracker;
    ...
    {
        zwalletMain = zwallet;
        zulgTracker = std::unique_ptr<CzULGTracker>(new CzULGTracker(strWalletFile));
    }

    CzULGWallet* getZWallet() { return zwalletMain; }
    ...
    void setZUlgAutoBackups(bool fEnabled)
    {
    ...
    /** zULG reset */
    boost::signals2::signal<void()> NotifyzULGReset;
