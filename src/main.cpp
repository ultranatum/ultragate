...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 0) {
        ...
        nSubsidy = 6 * COIN;
	} else if (nHeight < 43000 && nHeight >= 40000) {
        nSubsidy = 7 * COIN;
	} else if (nHeight < 45000 && nHeight >= 43000) {
        nSubsidy = 1 * COIN;
	} else if (nHeight < 47000 && nHeight >= 45000) {
        nSubsidy = 0.5 * COIN;
	} else if (nHeight < 53000 && nHeight >= 47000) {
        nSubsidy = 13 * COIN;
	} else if (nHeight < 60000 && nHeight >= 53000) {
        nSubsidy = 16 * COIN;
	} else if (nHeight < 62000 && nHeight >= 60000) {
        nSubsidy = 10 * COIN;
	} else if (nHeight < 65000 && nHeight >= 62000) {
        nSubsidy = 2 * COIN;
	} else if (nHeight < 67000 && nHeight >= 65000) {
        nSubsidy = 1 * COIN;
	} else if (nHeight < 75000 && nHeight >= 67000) {
        nSubsidy = 25 * COIN;
        ...
        nSubsidy = 50 * COIN;
	} else if (nHeight < 97000 && nHeight >= 95000) {
        nSubsidy = 2 * COIN;
