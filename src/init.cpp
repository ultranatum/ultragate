...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    string debugCategories = "addrman, alert, bench, coindb, db, lock, rand, rpc, selectcoins, tor, mempool, net, proxy, http, libevent, ultragate, (obfuscation, swiftx, masternode, mnpayments, mnbudget)"; // Don't translate these and qt below
    if (mode == HMM_BITCOIN_QT)
        debugCategories += ", qt";
...
//    }
//
//    nAnonymizeUltragateAmount = GetArg("-anonymizeultragateamount", 0);
//    if (nAnonymizeUltragateAmount > 999999) nAnonymizeUltragateAmount = 999999;
//    if (nAnonymizeUltragateAmount < 2) nAnonymizeUltragateAmount = 2;
    ...
    LogPrintf("Anonymize Ultragate Amount %d\n", nAnonymizeUltragateAmount);
