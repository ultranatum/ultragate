                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("UltraGate Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a UltraGate address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ultragate: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zULG"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About UltraGate Core"), this);
    aboutAction->setStatusTip(tr("Show information about UltraGate Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for UltraGate"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your UltraGate addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified UltraGate addresses"));
    ...
    openAction->setStatusTip(tr("Open a UltraGate: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the UltraGate Core help message to get a list with possible UltraGate command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to UltraGate network", "", count));
}
