 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZULG));
    typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
    // ulg typeWidget->addItem(tr("Received ULG from zULG"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    // ulg typeWidget->addItem(tr("Zerocoin Mint"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinMint));
    // ulg typeWidget->addItem(tr("Zerocoin Spend"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend));
    // ulg typeWidget->addItem(tr("Zerocoin Spend, Change in zULG"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zUlg));
    // ulg typeWidget->addItem(tr("Zerocoin Spend to Self"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_FromMe));
