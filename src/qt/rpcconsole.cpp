                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzULGPathCustom = GetArg("-zulgbackuppath", "");
    ...
    if(!strzULGPathCustom.empty()) {
        ui->wallet_customzulgbackuppath->setText(QString::fromStdString(strzULGPathCustom));
        ui->wallet_customzulgbackuppath_label->setVisible(true);
        ui->wallet_customzulgbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzULGPathCustom.empty()) && nCustomBackupThreshold > 0) {
