...
public:
    ...
    void setZUlgControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzULG_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzULG_clicked();
    void on_pushButtonZUlgControl_clicked();
